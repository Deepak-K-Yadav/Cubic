...
function ListDevice() {
  ...
  const [resp, setResp] = useState<TapResponse | null>(null);
  ...
  const [history, setHistory] = useState<TapHistoryItem[]>([]);
  ...
  //   const fareDetails = useMemo(() => {
  //   return {
  //     from: resp?.from ?? DEFAULT_FROM,
  //     to: resp?.to ?? DEFAULT_TO,
  //     distance_km: resp?.distance_km ?? DEFAULT_DISTANCE,
  //     fare: resp?.fare ?? 0,
  //     prev_balance: resp?.prev_balance ?? 0,
  //     remaining_balance: resp?.remaining_balance ?? 0,
  //     trip_state: resp?.trip_state ?? "—",
  //     reason: resp?.reason ?? "—",
  //     request_id: resp?.request_id ?? "—",
  //     device_ip: resp?.device_ip ?? "—",
  //     validator_version: resp?.validator_version ?? "—",
